...
@export var max_shoot_distance: float = 900.0
...
func _ready() -> void:
	...
	_fire_timer = randf_range(1.0, 2.5)
...
func _shoot_at_player() -> void:
	...
	var spawn_pos := _turret.global_position if _turret else global_position + Vector3.UP * 2.0
	...
	fire_bullet(spawn_pos + forward_dir * 4.0, forward_dir)
