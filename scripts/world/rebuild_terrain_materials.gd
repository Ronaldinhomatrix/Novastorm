...
func rebuild_materials() -> void:
	...
	if not pc_mat.shader:
		...
		return
	pc_mat.shader_parameter["albedo_texture"] = albedo_tex
	pc_mat.shader_parameter["normal_texture"] = normal_tex
	pc_mat.shader_parameter["uv_scale"] = 0.015
	pc_mat.shader_parameter["triplanar_sharpness"] = 4.0
	pc_mat.shader_parameter["normal_scale"] = 1.0
	pc_mat.shader_parameter["flat_tint"] = Color(0.95, 0.85, 0.7, 1)
	pc_mat.shader_parameter["cliff_tint"] = Color(0.4, 0.38, 0.38, 1)
	pc_mat.shader_parameter["slope_threshold"] = 0.55
	pc_mat.shader_parameter["slope_blend_smoothness"] = 0.2
	pc_mat.shader_parameter["flat_roughness"] = 0.9
	pc_mat.shader_parameter["cliff_roughness"] = 0.98
	pc_mat.shader_parameter["macro_noise_scale"] = 0.0008
	pc_mat.shader_parameter["macro_noise_strength"] = 0.5
	pc_mat.shader_parameter["strata_red_clay"] = Color(1.05, 0.75, 0.6, 1)
	pc_mat.shader_parameter["strata_cool_slate"] = Color(0.7, 0.78, 0.9, 1)
	pc_mat.shader_parameter["height_min"] = 100.0
	pc_mat.shader_parameter["height_max"] = 1600.0
	pc_mat.shader_parameter["height_blend_strength"] = 0.25
	pc_mat.shader_parameter["valley_tint"] = Color(0.85, 0.82, 0.78, 1)
	pc_mat.shader_parameter["peak_tint"] = Color(1, 0.98, 0.95, 1)
	pc_mat.shader_parameter["micro_detail_strength"] = 0.02
